const resumeObject = {
  ...
  list: {
    ...
    "Languages": [
      ...
      {item: "Oracle PL/SQL",                    level: "Advanced",     lastUsed: "2022"},
      {item: "SQL (DDL/DQL/DML/DCL)",            level: "Advanced",     lastUsed: "2022"},
      ...
      {item: "Regex",                            level: "Advanced",     lastUsed: "2022"},
    ...
    "Development Tools": [
      {item: "Visual Studio Code",               level: "Intermediate", lastUsed: "2022"},
      {
    ...
    "Workstation Tools": [
      {item: "Microsoft Windows 7/8/10",         level: "Intermediate", lastUsed: "2022"},
      {
      ...
      {item: "Oracle VM VirtualBox",             level: "Intermediate", lastUsed: "2022"},
      {item: "Thunderbird",                      level: "Intermediate", lastUsed: "2022"},
      ...
      {item: "Microsoft Paint & Paint 3D",       level: "Intermediate", lastUsed: "2022"},
    ],
    ...
    "Work Areas": [
      ...
      {item: "Quality Assurance",                level: "Advanced",     lastUsed: "2011"},
      {
        ...
        items: [
          ...
          {item: "Entity Relationship Modelling",level: "Intermediate", lastUsed: "2011"},
